...
export default async function PapersPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-6 py-16">
      <div className="mb-10">
        <div className="text-xs font-semibold tracking-[0.18em] text-indigo-300/80 mb-3 uppercase">Foundation Publications</div>
        <h1 className="text-4xl font-bold tracking-tight mb-3">Whitepapers</h1>
        <p className="text-white/60 leading-relaxed max-w-2xl">
          Long form publications of the Open Agent Protocol Foundation. Whitepapers describe the rationale and architectural commitments behind the protocol. They are normative only where they reference an accepted RFC or the core specification.
        </p>
      </div>
