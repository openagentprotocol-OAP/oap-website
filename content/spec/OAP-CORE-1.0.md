...
|-------|-------------|--------------|
| L0 | Compatible | Implements MCP or A2A and publishes a minimal OAP Manifest mapping. |
...
4. DID Resolver caching layer.
5. Trust Score computation and publication.
6. Sampling Service for Outcome Verification.
7. Ethics Board and Dispute Resolution Service.
8. Whistleblower intake under documented anonymity guarantees.
